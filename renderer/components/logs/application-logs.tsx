...
import { ApplicationLogsDataTable } from "components/logs/application-logs-data-table";
import { createApplicationLogsColumns } from "components/logs/application-logs-columns";
